...
// items respectively. Find out the maximum value subset(Maximum Profit) of v[] 
// such that the sum of the weights of this subset is smaller than or equal to 
// Knapsack capacity W.
...
// solution subtree rooted with every node. If the best in subtree is worse than current best,
// we can simply ignore this node and its subtrees.

// So we compute bound (best solution) for every node and compare the bound with 
// current best solution before exploring the node. 
